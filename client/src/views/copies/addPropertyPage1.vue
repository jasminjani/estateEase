...
const jobsCount = reactive([{ name: "", description: "", photos: null }]);

const name = useField("name");
const address = useField("address");
const city = useField("city");
const pincode = useField("pincode");
jobsCount[0].name = useField("jobname_0");
jobsCount[0].description = useField("job_description_0");
jobsCount[0].photos = useField("jobimage_0");
